...
const AboutMe = () => {
  ...
  return (
    <motion.div
      className="h-screen bg-about-bg bg-cover bg-no-repeat pt-32 md:overflow-hidden md:pt-32 md:px-10"
      initial="hidden"
      animate="visible"
      variants={container}
    >
      <motion.div className="" variants={container}>
        <div className="flex flex-row">
          <motion.img
            src={aboutImg}
            alt=""
            className="h-[250px] md:px-12 md:h-[60vh] "
            variants={item}
          />

          <motion.div className="px-2 md:w-[40vw] white" variants={item}>
            <motion.h1
              className="text-white font-extrabold text-center border-b-4 border-blue-500 md:w-32 md:pb-2 md:text-2xl md:whitespace-nowrap  lg:py-[10px]  font-league 2xl:text-3xl"
              variants={item}
            >
              MY BIOGRAPHY
            </motion.h1>
            ...
            <motion.p
              className="text-white text-[10px] md:font-semibold md:text-sm font-mono lg:text-[15px] 2xl:text-2xl"
              variants={item}
            >
      ...
      >
        ...
        <p className="text-xl text-white font-mono lg:text-2xl 2xl:text-4xl">PORTFOLIO 2026</p>
      </motion.div>
    </motion.div>
  );
};
